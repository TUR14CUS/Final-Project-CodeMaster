...
<footer class="container-fluid">
  ...
  <div class="row">
    <div class="col-12 p-0">
      <div style="overflow:hidden;max-width:100%;width:100%;height:503px;"><div id="google-maps-display" style="height:100%; width:100%;max-width:100%;"><iframe style="height:100%;width:100%;border:0;" frameborder="0" src="https://www.google.com/maps/embed/v1/place?q=Rua+Passo+Manuel,+59-1.º+4000-384+porto&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"></iframe></div><a class="google-map-html" href="https://www.bootstrapskins.com/themes" id="authorize-map-data">premium bootstrap themes</a><style></style></div>
    </div>
  </div>
  <!--Map-->
  <!--Bottom-->
